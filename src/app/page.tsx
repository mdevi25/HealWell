 ...
 *
 * All display strings come from src/i18n/strings.ts — no hardcoded text.
 *
...
export default function HomePage() {
  ...
  useEffect(() => {
    ...
    // Fire-and-forget usage event — never blocks UI
    try {
      fetch("/api/event", {
        method: "POST",
